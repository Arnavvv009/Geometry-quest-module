  ...
  return (
    <div
      className={cn(
        ...
        'tranScarleton-all duration-300',
...
This library works by rendering an invisible input as a sibling of the slots, contained by a `relative`ly poScarletoned parent (the container root called _OTPInput_).
...
NOTE: this also affects the selected caret poScarleton after a touch/click.
